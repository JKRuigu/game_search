getMax2 = (id) =>{
	if (getMaxColumn(id,truthTable2) == undefined && getMaxRow(id,truthTable2) != undefined) {
		// console.log("A");
		return ids[getMaxRow(id,truthTable2)];
	}else if (getMaxColumn(id,truthTable2) != undefined && getMaxRow(id,truthTable2) == undefined) {
		// console.log("B");
		return ids[getMaxColumn(id,truthTable2)];
	}else if (getMaxColumn(id,truthTable2) == undefined && getMaxRow(id,truthTable2) == undefined) {
		for (var i = 0; i < truthTable2.length; i++) {
			if (truthTable2[i]) {
			// console.log("C");
				return ids[i];
			}
		...
		// console.log(values[getMaxColumn(id,truthTable2)],values[getMaxRow(id,truthTable2)])
		if (values[getMaxRow(id,truthTable2)]> values[getMaxColumn(id,truthTable2)]) {
			// console.log("C");
			return ids[getMaxRow(id,truthTable2)];
		}else{
			// console.log("E");
